...
class DroneAutopilotGUI:
    ...
    def create_layout(self):
        ...
        map_frame.pack(side=tk.LEFT, fill=tk.BOTH, expand=True, padx=10)
        
        self.map_canvas = tk.Canvas(map_frame, bg="#333333", highlightthickness=0)
        ...
        # Status bar
        status_bar = ttk.Frame(map_frame)
